...
if(bisiesto== true){
    var msg = "El año " + year + " es bisiesto. <br /> El mes de " + mes + " tiene " + diasdelmes + " dias.";
}else{
    var msg = "El año " + year + " no es bisiesto. <br /> El mes de " + mes + " tiene " + diasdelmes + " dias.";
}
